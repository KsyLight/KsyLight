...
| **Методы анализа данных**                    | - A/B-тестирование<br/>- Исследовательский анализ данных (EDA)<br/>- Статистический анализ (в том числк татистические тесты (t-тест, ANOVA, χ² и другие) и другие)  <br/>- Прогнозирование |
